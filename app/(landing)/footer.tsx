...
export default function FooterSection() {
    return (
        <footer className='relative z-10 py-16 md:py-32'>
            <div className='mx-auto max-w-5xl px-6'>
                <Link
                    ...
                    <span className='text-xl font-medium'>Junta de Vecinos<br />Pinto Los Pellines</span>
                </Link>
                ...
                <div className='my-8 text-center'>
                    <div className='text-sm text-muted-foreground space-y-2'>
                        <p><strong>Dirección:</strong> Pinto Los Pellines, Ñuble, Chile</p>
                        <p><strong>Email:</strong> Contacto disponible en directorio comunitario</p>
                        <p><strong>Teléfono:</strong> Información disponible en directorio comunitario</p>
                    </div>
                </div>
                ...
                <span className="text-muted-foreground block text-center text-sm mt-4">
                    © {new Date().getFullYear()} Junta de Vecinos Pinto Los Pellines, All rights reserved
                </span>
                <span className="text-muted-foreground block text-center text-xs mt-2">
                    Powered by ΛRΛMΛC
                </span>
            </div>
        </footer>
