                    ...
                    <div className='relative mx-auto max-w-6xl px-6 pb-20 pt-32 lg:pt-48' >
                        <div className='relative z-10 mx-auto max-w-4xl text-center' >
                            ...
                            <TextEffect
                                ...
                                Plataforma de gestión comunitaria moderna con cámaras de seguridad, pagos integrados y herramientas completas de gestión vecinal.
                            </TextEffect>
    ...
    return (
        <div className='relative space-y-3 rounded-[1rem] bg-white/5 p-4' >
            ...
            <div className='space-y-3' >
                <div className='text-foreground border-b border-white/10 pb-3 text-sm font-medium' >Esta semana, la participación comunitaria ha aumentado significativamente.</div>
                <div className='space-y-3' >
                    <div className='space-y-1' >
                        <div className='space-x-1' >
                            <span className='text-foreground align-baseline text-xl font-medium' >156</span>
                            <span className='text-muted-foreground text-xs' >Vecinos activos</span>
                        </div>
                        <div className='flex h-5 items-center rounded bg-gradient-to-l from-emerald-400 to-indigo-600 px-2 text-xs text-white' >Esta semana</div>
                    </div>
                    <div className='space-y-1' >
                        <div className='space-x-1' >
                            <span className='text-foreground align-baseline text-xl font-medium' >89</span>
                            <span className='text-muted-foreground text-xs' >Vecinos activos</span>
                        </div>
                        <div className='text-foreground bg-muted flex h-5 w-2/3 items-center rounded px-2 text-xs dark:bg-white/20' >Semana pasada</div>
                    </div>
                </div>
            </div>
        </div>
