  ...
  const contributionCategories = [
    {
      ...
      description:
        'Apoya económicamente el desarrollo y mantenimiento de Pinto Los Pellines',
      icon: DollarSign,
      ...
      items: [
        {
          ...
          description:
            'Contribuciones únicas o recurrentes para proyectos comunitarios',
          action: 'Ir a Donar',
          link: '/donate',
          icon: Heart,
          external: false,
        },
        {
          ...
          description:
            'Alianzas con empresas locales para proyectos específicos',
          action: 'Contactar',
      ...
      items: [
        {
          ...
          description:
            'Ayuda en organización de fiestas, talleres y actividades sociales',
          action: 'Ver Eventos',
        ...
        },
        {
          title: 'Mantenimiento',
          description:
            'Colabora en reparaciones, limpieza y mejoras del barrio',
          action: 'Postular',
          link: '/dashboard/contacts',
          icon: Wrench,
          external: false,
      ...
      items: [
        {
          ...
          description:
            'Contribuye al código fuente de la plataforma comunitaria',
          action: 'GitHub',
      ...
      <div className="min-h-screen relative overflow-hidden bg-background">
        ...
        <div className="fixed inset-0 -z-10">
          <Image
            ...
            alt="Contribuciones Page Background"
            fill
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 relative z-10">
          ...
          >
            ...
            >
              Hay muchas maneras de ser parte del crecimiento y desarrollo de
              Pinto Los Pellines.
              <span className="text-amber-600 dark:text-amber-400 font-semibold">
                {' '}
                Tu participación
              </span>
              , sea cual sea su forma, es invaluable para nuestra comunidad.
            </motion.p>
            ...
            {contributionCategories.map((category, categoryIndex) => (
              ...
              >
                ...
                <div className="text-center mb-12">
                  <motion.div
                    className={`inline-flex p-4 rounded-full ${category.bgColor} mb-6 shadow-xl border-2 border-border/60`}
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {category.items.map((item, itemIndex) => (
                    <motion.div
                      ...
                      transition={{
                        delay: 1.2 + categoryIndex * 0.2 + itemIndex * 0.1,
                        duration: 0.5,
                      }}
                      whileHover={{ scale: 1.08, y: -5 }}
                      whileTap={{ scale: 0.98 }}
                    >
                      <Card className="h-full group bg-card/95 backdrop-blur-sm border-2 border-border/50 hover:border-amber-300/70 dark:hover:border-amber-600/70 shadow-xl hover:shadow-2xl transition-all duration-500 overflow-hidden relative">
                        ...
                        <CardHeader className="pb-4">
                          <div className="flex items-center space-x-4 mb-3">
                            ...
                            <CardTitle className="text-xl font-semibold text-card-foreground group-hover:text-card-foreground/80 transition-colors">
                              {item.title}
                            </CardTitle>
                          </div>
          ...
          <motion.div
            ...
            className="bg-card rounded-2xl p-10 shadow-2xl border border-border mt-20 text-center relative overflow-hidden"
          >
            ...
            >
              Todas las formas de contribuir son importantes. Si tienes alguna
              duda sobre cómo participar,
              <span className="text-amber-600 dark:text-amber-400 font-semibold">
                {' '}
            ...
            >
              ...
              >
                ...
                >
                  <Link href={ROUTES.DASHBOARD_CONTACTS}>
          ...
          >
            <div className="bg-card/98 backdrop-blur-sm rounded-2xl p-8 border border-border/60">
              <motion.div
              ...
              >
                ...
                <span className="text-amber-600 dark:text-amber-400 font-semibold">
                  {' '}
                  Juntos construimos un mejor futuro para todos
                </span>
                . 🙏
              </motion.p>
            </div>
