  ...
  const handleDeleteAnnouncement = async (announcementId: string) => {
    if (
      ...
      try {
        ...
        alert(
          'Error al eliminar el comunicado. Por favor, inténtalo de nuevo.'
        );
      }
    }
  };
            ...
            <CardContent>
              <div className="text-2xl font-bold text-blue-600">
                {allAnnouncements.reduce(
                  (acc: number, a: any) => acc + a.readBy.length,
                  0
                )}
              </div>
            </CardContent>
          ...
          {loading ? (
            ...
            <div className="space-y-4">
              {filteredAnnouncements.map((announcement: any, index: number) => {
                ...
                const category =
                  categoryConfig[
                    announcement.category as keyof typeof categoryConfig
                  ];
                      ...
                      >
                        <CardHeader className="pb-3">
                          <div className="flex items-start justify-between">
                            <div className="flex items-center space-x-2">
                              <PriorityIcon
                                className={`w-5 h-5 ${priority.color.includes('red') ? 'text-red-600' : priority.color.includes('yellow') ? 'text-yellow-600' : 'text-blue-600'}`}
                              />
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center space-x-2">
                              <Button
                                ...
                                size="sm"
                                onClick={() =>
                                  handleViewAnnouncement(announcement as any)
                                }
                              >
                                <Eye className="w-4 h-4" />
                              </Button>
                              <Button
                                ...
                                size="sm"
                                onClick={() =>
                                  handleEditAnnouncement(announcement as any)
                                }
                              >
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="flex items-center space-x-2 mt-2">
                    ...
                    <Badge
                      variant={
                        selectedAnnouncement.isActive ? 'default' : 'secondary'
                      }
                    >
                ...
                <div className="flex items-center justify-between text-sm text-gray-600 dark:text-gray-400">
                  <div className="flex items-center space-x-4">
                    ...
                    <span>
                      Leído por: {selectedAnnouncement.readBy.length} personas
                    </span>
                  </div>
                </div>
              </div>
