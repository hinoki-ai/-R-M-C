...
import { AlertTriangle, Edit, Eye, Filter, Mail, MapPin, Phone, Plus, Trash2, User } from 'lucide-react'
...
interface Contact {
  ...
  availability?: string
  hours?: string
  type: 'directiva' | 'seguridad' | 'social' | 'municipal' | 'health' | 'police' | 'fire' | 'service'
  description?: string
  location?: string
  isActive: boolean
  createdBy: string
...
function AdminContactsContent() {
  ...
  const [typeFilter, setTypeFilter] = useState<'all' | keyof typeof contactTypeConfig>('all')
  ...
  const handleDeleteContact = async (contactId: string) => {
    if (confirm('¿Estás seguro de que quieres eliminar este contacto? Esta acción lo desactivará permanentemente.')) {
      try {
  ...
  return (
    ...
    >
      <div className='space-y-6'>
            ...
            <CardContent className='p-6'>
              <div className='flex items-center justify-between'>
                <div>
                  ...
                  <p className='text-2xl font-bold'>{loading ? '...' : allContacts.length}</p>
                </div>
              ...
              <div className='flex items-center justify-between'>
                <div>
                  ...
                  <p className='text-2xl font-bold text-green-600'>
                    {loading ? '...' : allContacts.filter((c: any) => c.isActive).length}
                  </p>
                </div>
        ...
        {/* Create/Edit Dialogs - TODO: Implement contact form component */}
          ...
          <DialogContent>
            ...
            <div className='py-4'>
              <p className='text-center text-gray-600 dark:text-gray-400'>
                Formulario de creación de contacto próximamente...
              </p>
            </div>
          </DialogContent>
        </Dialog>
        ...
        <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
          <DialogContent>
            ...
            <div className='py-4'>
              <p className='text-center text-gray-600 dark:text-gray-400'>
                Formulario de edición de contacto próximamente...
              </p>
            </div>
          </DialogContent>
        </Dialog>
              ...
              {selectedContact && (
                <div className='space-y-4'>
                  ...
                  <div>
                    ...
                    <p>{contactTypeConfig[selectedContact.type].emoji} {contactTypeConfig[selectedContact.type].label}</p>
                  </div>
