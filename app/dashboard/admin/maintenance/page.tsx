...
function AdminMaintenanceContent() {
  const { user } = useUser();
  const allRequests =
    useQuery(api.maintenance.getAllMaintenanceRequests, {}) || [];
  ...
  const handleDeleteRequest = async (requestId: string) => {
    if (
      !confirm(
        '¿Estás seguro de que quieres eliminar esta solicitud de mantenimiento? Esta acción no se puede deshacer.'
      )
    ) {
      return;
    }
          ...
          {loading ? (
            ...
            filteredRequests.map((request: MaintenanceRequest) => {
              ...
              return (
                ...
                >
                  <Card
                    className={`border-l-4 ${priorityConfig[request.priority].color}`}
                  >
                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-2">
                            ...
                            <Badge
                              variant="outline"
                              className={`text-xs ${statusConfig[request.status].color}`}
                            >
                    ...
                    <CardContent>
                      ...
                      <div className="flex items-center justify-between text-xs text-gray-500">
                        <div>Reportado: {formatDate(request.reportedAt)}</div>
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="text-sm font-medium">Categoría</label>
                    <p className="text-sm text-gray-600">
                      {categoryConfig[selectedRequest.category].emoji}{' '}
                  ...
                  <div>
                    <label className="text-sm font-medium">Prioridad</label>
                    <p className="text-sm text-gray-600">
                      {priorityConfig[selectedRequest.priority].badge}
                    </p>
                  </div>
                  <div>
                    <label className="text-sm font-medium">Estado</label>
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      {formatDate(selectedRequest.reportedAt)}
                    </p>
                  </div>
                </div>
...
export default function AdminMaintenancePage() {
  return <AdminMaintenanceContent />;
}
