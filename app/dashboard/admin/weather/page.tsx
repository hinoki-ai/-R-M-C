...
function AdminWeatherContent() {
  ...
  >('all');
  const [typeFilter, setTypeFilter] = useState<'all' | keyof typeof typeConfig>(
    'all'
  );
  ...
  const handleDeleteAlert = async (alertId: string) => {
    if (
      confirm(
        '¿Estás seguro de que quieres eliminar esta alerta meteorológica? Esta acción no se puede deshacer.'
      )
    ) {
      try {
        ...
        alert(
          'Error al eliminar la alerta meteorológica. Por favor, inténtalo de nuevo.'
        );
      }
    }
  };
        ...
        >
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400 mt-1">
              Administra todas las alertas y avisos meteorológicos para la
              comunidad
            </p>
          </div>
          <Button
          ...
          {loading ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-4">
                {filter === 'all'
                  ? 'Crea tu primera alerta meteorológica para comenzar.'
            ...
            <div className="space-y-4">
              {filteredAlerts.map((alert: any, index: number) => {
                ...
                return (
                  ...
                  >
                    <Card
                      className={`border-l-4 ${severity.borderColor} ${severity.bgColor} hover:shadow-lg transition-shadow ${isExpired ? 'opacity-75' : ''}`}
                    >
                      <CardHeader className="pb-3">
                        <div className="flex items-start justify-between">
                          <div className="flex items-center space-x-3">
                            <span className={`text-2xl ${type.color}`}>
                              {type.emoji}
                            </span>
                            <div>
        ...
        <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
          <DialogContent className="max-w-2xl">
            <DialogHeader>
              ...
              <DialogDescription>
                Crea una nueva alerta meteorológica con sus instrucciones de
                seguridad.
              </DialogDescription>
            </DialogHeader>
            <WeatherAlertForm
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="flex items-center space-x-2 mt-2">
                    ...
                    <Badge
                      variant={selectedAlert.isActive ? 'default' : 'secondary'}
                    >
