...
import { IconCamera, IconWifi, IconWifiOff, IconAlertCircle, IconServer, IconBroadcast, IconEye, IconCpu } from '@tabler/icons-react'
          ...
          <CardContent className='p-4'>
            <div className='flex items-center gap-3'>
              ...
              <div>
                ...
                <p className='text-sm text-gray-600 dark:text-gray-400'>Cámaras Total</p>
              </div>
            </div>
          </CardContent>
        </Card>
        <Card>
          <CardContent className='p-4'>
            <div className='flex items-center gap-3'>
              ...
              <div>
                <p className='text-2xl font-bold'>{lsvisionCameras.filter(c => c.isOnline).length}</p>
          ...
          <CardContent>
            <div className='space-y-4'>
              <p className='text-gray-600 dark:text-gray-400'>
                No hay cámaras LS Vision configuradas en el sistema.
                Para agregar cámaras, configura los UIDs de O-Kamm:
              </p>
              <div className='bg-gray-50 dark:bg-gray-800 p-4 rounded-lg space-y-2'>
                <div className='font-mono text-sm'>
                  <span className='text-gray-500'># Para múltiples cámaras:</span><br/>
                  <span className='text-blue-600'>LSVISION_UID_1=VE4386930MLXU</span><br/>
                  <span className='text-blue-600'>LSVISION_UID_2=XXXXXXXXXXXX</span><br/>
                  <span className='text-blue-600'>LSVISION_UID_3=YYYYYYYYYYYY</span>
                </div>
              </div>
              <div className='bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg'>
                <h4 className='font-semibold text-blue-800 dark:text-blue-200 mb-2'>Especificaciones Técnicas:</h4>
                <ul className='text-sm text-blue-700 dark:text-blue-300 space-y-1'>
                  <li>• <strong>Protocolo:</strong> HLS (HTTP Live Streaming)</li>
                  <li>• <strong>Proveedor:</strong> O-Kamm Cloud Platform</li>
                  <li>• <strong>Acceso:</strong> Solo visualización (View-Only)</li>
                  <li>• <strong>Latencia:</strong> 3-5 segundos (típica)</li>
                    ...
                    <CardContent>
                      ...
                      <div className='grid grid-cols-2 gap-4 text-sm mb-4'>
                        <div>
                          ...
                          <p className='text-gray-900 dark:text-gray-100'>{camera.location || 'Centro Comunitario'}</p>
                        </div>
                        <div>
                          <span className='font-medium text-gray-500'>Resolución:</span>
                          <p className='text-gray-900 dark:text-gray-100'>{camera.resolution || '1920x1080'}</p>
                        </div>
                        <div>
                          <span className='font-medium text-gray-500'>Frame Rate:</span>
                          <p className='text-gray-900 dark:text-gray-100'>{camera.frameRate || 30} FPS</p>
                        </div>
                        <div>
                          <span className='font-medium text-gray-500'>Cámaras:</span>
                          <p className='text-gray-900 dark:text-gray-100'>{activeFeeds.length} activas</p>
                        </div>
                      </div>
                      ...
                      <div className='space-y-2'>
                        <div className='flex justify-between text-sm'>
                          ...
                          <span className='text-gray-600 dark:text-gray-400'>HD 1080p</span>
                        </div>
                          ...
                          <div className='bg-gray-50 dark:bg-gray-800 p-3 rounded-lg'>
                            <div className='grid grid-cols-2 gap-4 text-xs'>
                              <div>
                                ...
                                <p className='text-gray-900 dark:text-gray-100'>HLS / O-Kamm</p>
                              </div>
                              <div>
                                <span className='font-medium text-gray-500'>Latency:</span>
                                <p className='text-gray-900 dark:text-gray-100'>~3-5s</p>
                              </div>
                              <div>
                                <span className='font-medium text-gray-500'>Codec:</span>
                                <p className='text-gray-900 dark:text-gray-100'>H.264</p>
                              </div>
                              <div>
                                <span className='font-medium text-gray-500'>Bitrate:</span>
                                <p className='text-gray-900 dark:text-gray-100'>2-4 Mbps</p>
                              </div>
                            </div>
                          </div>
                        </div>
              ...
              <div className='flex items-center justify-between'>
                ...
                <div className='text-right'>
                  <div className='text-2xl font-bold text-blue-600 mb-1'>
                    {lsvisionCameras.filter(c => c.isOnline).length}/{lsvisionCameras.length}
                  </div>
