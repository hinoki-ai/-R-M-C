      ...
      <div className="text-center py-12">
        ...
        {!isOnline && (
          <Alert>
            ...
            <AlertDescription>
              Las cámaras se cargarán automáticamente cuando recuperes la
              conexión a internet.
            </AlertDescription>
          </Alert>
        )}
...
function CamerasPageContent() {
  ...
  const {
    ...
    retry,
    isError,
  } = useConvexQueryWithError(api.cameras.getCameras, {
    maxRetries: 3,
    retryDelay: 1000,
    onError: (error: any) => {
      ...
      <div className="flex items-center justify-center py-20">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Please sign in to access camera management.
          </p>
        </div>
      </div>
    );
    ...
    <div className="container mx-auto px-4 py-8 relative">
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <Button asChild className="flex items-center gap-2">
                <Link href={ROUTES.DASHBOARD_CAMERAS_ADD}>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-green-600">
                  {isLoading
                    ? '...'
                    : cameras.filter(c => c.isOnline && c.isActive).length}
                </p>
              </div>
                ...
                <div className="space-y-2 mb-4">
                  ...
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="font-mono text-xs">
                      {camera.streamUrl.substring(0, 30)}...
                    </span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-600 dark:text-gray-400">
