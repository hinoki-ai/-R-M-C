...
const mapLocations = [
  {
    id: 1,
    name: 'Plaza de Armas',
    description: 'Centro cívico de Pinto con municipalidad, iglesia y comercio local',
  ...
  },
  {
    ...
    description: 'Centro cultural con libros, computadoras y actividades educativas',
  ...
  },
  {
    ...
    description: 'Instalaciones deportivas para fútbol y actividades recreativas',
  ...
  return (
    <div className='space-y-8'>
      ...
      <div className='text-center space-y-4'>
        ...
        >
          <h1 className='text-4xl font-bold tracking-tight'>Mapa de Pinto Los Pellines</h1>
          <p className='text-xl text-muted-foreground max-w-3xl mx-auto'>
            Explora los lugares importantes de nuestra comunidad.
            Encuentra servicios, comercios, espacios públicos y puntos de interés.
          </p>
        </motion.div>
      </div>
            ...
            <div className='relative bg-gradient-to-br from-green-100 to-blue-100 dark:from-green-900/20 dark:to-blue-900/20 rounded-lg h-96 flex items-center justify-center border-2 border-dashed border-gray-300 dark:border-gray-600'>
              <div className='text-center space-y-4'>
                ...
                <p className='text-muted-foreground max-w-md'>
                  Aquí se mostraría un mapa interactivo con todos los puntos de interés.
                  En una implementación real, usaríamos Google Maps, OpenStreetMap o Mapbox.
                </p>
      ...
      >
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
          {filteredLocations.map((location) => (
            <Card key={location.id} className='hover:shadow-lg transition-all duration-300 hover:scale-105 cursor-pointer group'>
              <CardHeader className='pb-3'>
                <div className='flex items-center justify-between mb-2'>
                  <Badge className={`${getCategoryColor(location.category)} text-white`}>
                    {mapCategories.find(c => c.id === location.category)?.name || 'General'}
                  </Badge>
      ...
      >
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Herramientas y funcionalidades disponibles en nuestro mapa comunitario
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4'>
              <div className='text-center p-4 border rounded-lg'>
                ...
                <p className='text-sm text-muted-foreground'>Encuentra lugares por nombre o dirección</p>
              </div>
              <div className='text-center p-4 border rounded-lg'>
                <div className='text-3xl mb-2'>📍</div>
                <h3 className='font-semibold mb-1'>Ubicación</h3>
                <p className='text-sm text-muted-foreground'>Ve tu ubicación actual en el mapa</p>
              </div>
              <div className='text-center p-4 border rounded-lg'>
                <div className='text-3xl mb-2'>🚗</div>
                <h3 className='font-semibold mb-1'>Rutas</h3>
                <p className='text-sm text-muted-foreground'>Obtén direcciones para llegar a cualquier lugar</p>
              </div>
              <div className='text-center p-4 border rounded-lg'>
                <div className='text-3xl mb-2'>📱</div>
                <h3 className='font-semibold mb-1'>Offline</h3>
                <p className='text-sm text-muted-foreground'>Descarga mapas para usar sin conexión</p>
              </div>
            </div>
          </CardContent>
        </Card>
      ...
      >
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Ayúdanos a mantener el mapa actualizado con lugares de interés comunitario
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className='text-center space-y-4'>
              ...
              <p className='text-muted-foreground'>
                Si conoces un negocio, servicio público o lugar de interés que no está en el mapa,
                ayúdanos a agregarlo para beneficio de toda la comunidad.
              </p>
...
export default function MapsPage() {
  return (
    <DocumentDashboardLayout user={{ id: '', name: 'Usuario', email: '', role: 'user', isAdmin: false }} currentSection='maps'>
      <MapsContent />
