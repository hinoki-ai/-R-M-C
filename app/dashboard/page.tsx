...
import {
  MobileCard,
  MobileDashboard,
} from '@/components/dashboard/mobile-dashboard';
...
import { PanelSection, PanelCard } from '@/components/ui/panel';
...
function CommunityEvents() {
  ...
  return (
    <PanelSection
      ...
      description="Próximos eventos y actividades comunitarias"
      variant="glass"
      rounded="xl"
      hover="lift"
    >
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Condiciones climáticas y alertas de seguridad
        </CardDescription>
      </CardHeader>
      <CardContent>
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Monitoreo y alertas de seguridad comunitaria
        </CardDescription>
      </CardHeader>
      <CardContent>
        <div className="space-y-4">
...
function NeighborhoodDirectory() {
  const services = [
    {
      name: 'Directiva Junta de Vecinos',
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Contactos importantes de la junta de vecinos
        </CardDescription>
      </CardHeader>
      <CardContent>
        <div className="space-y-3">
          {services.map((service, index) => (
            <div
              key={index}
              className="flex items-center justify-between p-3 bg-muted/80 rounded"
            >
              <div>
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Tareas de mantenimiento próximas y vencidas
        </CardDescription>
      </CardHeader>
      <CardContent>
    ...
    <div className={DASHBOARD_SPACING.page.container}>
      ...
      >
        <div>
          ...
          <div
            className={`flex items-center ${DASHBOARD_SPACING.element.tight} mt-3`}
          >
      ...
      <BentoGrid className="px-4 lg:px-6">
        ...
        <StaggerReveal staggerDelay={150} direction="up">
          <BentoGridItem colSpan={1}>
            <Link href={ROUTES.DASHBOARD_ANNOUNCEMENTS}>
              <InteractiveCard
              ...
              >
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground">
                    Último: Reunión Junta Ordinaria
                  </p>
                  <div className="mt-3">
          ...
          <BentoGridItem colSpan={1}>
            <Link href={ROUTES.DASHBOARD_MAINTENANCE}>
              <InteractiveCard
              ...
              >
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground">
                    Crítico: Reparación de semáforo
                  </p>
                  <div className="mt-3">
                    <Badge variant="default" className="text-xs">
                      Ver detalles →
          ...
          <BentoGridItem colSpan={1}>
            <Link href={ROUTES.DASHBOARD_EMERGENCIES}>
              <InteractiveCard
          ...
          <BentoGridItem colSpan={1}>
            <Link href={ROUTES.DASHBOARD_CAMERAS}>
              <InteractiveCard
          ...
          <BentoGridItem colSpan={1}>
            <Link href={ROUTES.DASHBOARD_WEATHER}>
              <InteractiveCard
            ...
            <DashboardSection isLoading={isInitialLoading} type="activity">
              <Card className="h-full border-0 bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800">
                <CardHeader>
                  ...
                  <CardDescription>
                    Últimas actualizaciones comunitarias
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1">
                        <p className="text-sm font-medium">
                          Nueva alerta de seguridad en zona norte
                        </p>
                        <p className="text-xs text-muted-foreground">
                          Hace 30 minutos
                        </p>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1">
                        <p className="text-sm font-medium">
                          Solicitud de mantenimiento completada
                        </p>
                        <p className="text-xs text-muted-foreground">
                          Hace 2 horas
                        </p>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1">
                        <p className="text-sm font-medium">
                          Nuevo evento: Campaña de reciclaje
                        </p>
                        <p className="text-xs text-muted-foreground">
                          Hace 4 horas
                        </p>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1">
                        <p className="text-sm font-medium">
                          Cámara de seguridad reactivada
                        </p>
                        <p className="text-xs text-muted-foreground">
                          Hace 6 horas
                        </p>
...
// TODO: Remove this component after initial admin setup is complete
// <AdminSetup /> has been temporarily commented out to prevent dashboard interference
