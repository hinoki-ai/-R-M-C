  ...
  return (
    <>
      <div className="mx-auto max-w-2xl space-y-4 text-center">
        ...
        <p>
          Esta sección está disponible con contribuciones activas. Elige el
          nivel que se ajuste a tu capacidad de apoyar a Pinto Los Pellines.
        </p>
      </div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="rounded-lg border bg-card p-6">
            ...
            <p className="text-muted-foreground">
              Acceso a herramientas avanzadas para la gestión comunitaria,
              reportes detallados y participación activa en decisiones del
              barrio.
            </p>
          </div>
        </div>
