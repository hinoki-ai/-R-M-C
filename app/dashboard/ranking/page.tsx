...
function RankingsError({
  ...
  return (
    <div className="space-y-6">
      <div className="text-center py-8">
        <div className="text-4xl mb-4">{!isOnline ? '📶' : '⚠️'}</div>
        <h1 className="text-2xl font-semibold text-gray-900 dark:text-white mb-2">
      ...
      {!isOnline && (
        <Alert>
          ...
          <AlertDescription>
            Los rankings se cargarán automáticamente cuando recuperes la
            conexión a internet.
          </AlertDescription>
        </Alert>
      )}
...
const RankingPageContent = memo(function RankingPageContent() {
  const {
    ...
    isOffline,
    cached,
  } = useOfflineFallback<MemberRanking[]>(api.community.getMemberRankings, {
  ...
  const stats = useMemo(() => {
    ...
    const rankCounts = typedRankingsQuery.reduce(
      (acc, member) => {
    ...
    const totalDonations = typedRankingsQuery.reduce(
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Miembros ordenados por rango, donaciones y meses consecutivos de
            suscripción
          </CardDescription>
        </CardHeader>
        <CardContent>
            ...
            <Table aria-label="Tabla de rankings de miembros de la comunidad">
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead className="text-right w-32" scope="col">
                    Donaciones Totales
                  </TableHead>
                  <TableHead className="text-right w-32" scope="col">
                    Meses Consecutivos
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <Card className="border-green-200 dark:border-green-800">
          ...
          <CardContent>
            <p className="text-sm text-muted-foreground">
              Miembros nuevos en la comunidad. Menos de $15,000 en donaciones y
              menos de 6 meses consecutivos de suscripción.
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="border-orange-200 dark:border-orange-800">
          ...
          <CardContent>
            <p className="text-sm text-muted-foreground">
              Miembros en crecimiento. $15,000+ en donaciones o 6+ meses
              consecutivos de suscripción.
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="border-blue-200 dark:border-blue-800">
          ...
          <CardContent>
            <p className="text-sm text-muted-foreground">
              Miembros establecidos. $50,000+ en donaciones o 12+ meses
              consecutivos de suscripción.
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="border-purple-200 dark:border-purple-800">
          ...
          <CardContent>
            <p className="text-sm text-muted-foreground">
              Líderes de la comunidad. $150,000+ en donaciones o 24+ meses
              consecutivos de suscripción.
            </p>
          </CardContent>
        </Card>
