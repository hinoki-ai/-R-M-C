        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4 px-4 lg:px-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Total revenue and key metrics</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Payment processing and methods</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Dynamic pricing and rates</CardDescription>
            </CardHeader>
            <CardContent>
