    ...
    <div className="min-h-screen relative">
      ...
      <div className="fixed inset-0 -z-10">
        <Image
          ...
          alt="Mobile Demo Page Background"
          fill
        ...
        <div className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground max-w-xl mx-auto">
              Modern mobile weather widgets with swipe gestures, compact views,
              and 7-day forecasts optimized for home screen placement.
            </p>
          </div>
          ...
          <div className="mt-12">
            ...
            <p className="text-sm text-muted-foreground text-center mb-6 max-w-2xl mx-auto">
              Swipe left/right to navigate between current weather, hourly
              forecast, 7-day forecast, and alerts. Features smooth animations
