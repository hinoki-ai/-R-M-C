    ...
    <main className='min-h-screen relative overflow-hidden' >
          ...
          <div className='text-center space-y-12' >
            ...
            >
              <Button
                size='lg'
                variant='outline'
                className='bg-white/10 border-white/30 text-white hover:bg-white/20 font-bold px-8 py-4 rounded-2xl shadow-2xl hover:shadow-white/25 transition-all duration-300 hover:-translate-y-1'
              >
            ...
            <div className='mt-20' >
              ...
              >
                {[
                  ...
                  <Card key={index} className='mx-4 bg-white/10 border-white/20 hover:bg-white/20 transition-all duration-300 hover:scale-105' >
        ...
        <div className='container mx-auto px-4' >
          ...
          >
            <Link href='/dashboard/emergencias' >
              <Card className='group relative overflow-hidden bg-gradient-to-br from-red-900/20 to-red-800/10 border-red-500/30 hover:border-red-400/50 transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-red-500/25' >
            ...
            <Link href='/anuncios' >
              <Card className='group relative overflow-hidden bg-gradient-to-br from-blue-900/20 to-blue-800/10 border-blue-500/30 hover:border-blue-400/50 transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-blue-500/25' >
            ...
            <Link href='/dashboard/events' >
              <Card className='group relative overflow-hidden bg-gradient-to-br from-green-900/20 to-green-800/10 border-green-500/30 hover:border-green-400/50 transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-green-500/25' >
            ...
            <Link href='/documentos' >
              <Card className='group relative overflow-hidden bg-gradient-to-br from-yellow-900/20 to-yellow-800/10 border-yellow-500/30 hover:border-yellow-400/50 transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-yellow-500/25' >
      ...
      <section className='relative py-16'>
        <div className='container mx-auto px-4 relative z-10'>
          <TextEffect
            ...
            per='word'
            as='h2'
            className='text-3xl md:text-4xl font-bold text-center mb-12 text-white drop-shadow-2xl'
          >
            🏪 Comercios Locales Destacados
          </TextEffect>
          ...
          >
            <Card className='bg-white/10 border-white/20 hover:bg-white/20 transition-all duration-300 hover:scale-105 group'>
              <CardHeader>
                ...
                <CardTitle className='text-2xl text-white group-hover:text-amber-100 transition-colors'>
              ...
              <CardContent>
                ...
                <div className='flex justify-between items-center'>
                  <div className='text-white/60 text-sm'>📞 +56 42 987 6543</div>
            ...
            <Card className='bg-white/10 border-white/20 hover:bg-white/20 transition-all duration-300 hover:scale-105 group'>
              ...
              <CardContent>
                ...
                <div className='flex justify-between items-center'>
                  <div className='text-white/60 text-sm'>📞 +56 42 555 1234</div>
                  <Button size='sm' variant='outline' className='bg-white/10 border-white/30 text-white hover:bg-white/20'>
                    Ver Más
                  </Button>
                </div>
            ...
            <Card className='bg-white/10 border-white/20 hover:bg-white/20 transition-all duration-300 hover:scale-105 group'>
              ...
              <CardContent>
                ...
                <div className='flex justify-between items-center'>
                  <div className='text-white/60 text-sm'>📞 +56 42 777 4567</div>
                  <Button size='sm' variant='outline' className='bg-white/10 border-white/30 text-white hover:bg-white/20'>
                    Ver Más
                  </Button>
                </div>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-3 gap-8'>
              ...
              <Card className='bg-white/10 border-white/20'>
                <CardHeader className='text-center'>
                  ...
                  <CardTitle className='text-2xl text-white'>Clima Actual</CardTitle>
                  <CardDescription className='text-white/70'>Pinto Los Pellines, Ñuble</CardDescription>
                </CardHeader>
                <CardContent className='text-center'>
                  <div className='text-4xl font-bold text-white mb-2'>22°C</div>
                  <div className='text-white/80 mb-4'>Despejado</div>
              ...
              <Card className='bg-white/10 border-white/20'>
                <CardHeader>
                  <CardTitle className='text-xl text-white'>Pronóstico 5 Días</CardTitle>
                </CardHeader>
                <CardContent>
                      ...
                      <div key={index} className='flex items-center justify-between'>
                        <div className='flex items-center gap-3'>
                          ...
                          <div>
                            ...
                            <div className='text-white/70 text-sm'>{forecast.desc}</div>
                          </div>
                        </div>
                        <div className='text-white font-bold'>{forecast.temp}</div>
                      </div>
                    ))}
                  </div>
                </CardContent>
              ...
              <Card className='bg-white/10 border-white/20'>
                <CardHeader>
                  <CardTitle className='text-xl text-white'>Información Agrícola</CardTitle>
                  <CardDescription className='text-white/70'>Relevante para la zona rural</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className='space-y-4'>
                    <div className='flex items-center justify-between'>
                      <span className='text-white/80'>Índice UV</span>
                      <Badge className='bg-yellow-500/20 text-yellow-300'>Alto (7)</Badge>
                    </div>
                    <div className='flex items-center justify-between'>
                      <span className='text-white/80'>Riego recomendado</span>
                      <Badge className='bg-blue-500/20 text-blue-300'>Moderado</Badge>
                    </div>
                    <div className='flex items-center justify-between'>
                      <span className='text-white/80'>Calidad del aire</span>
                      <Badge className='bg-green-500/20 text-green-300'>Buena</Badge>
                    </div>
                    <div className='flex items-center justify-between'>
                      <span className='text-white/80'>Época de cosecha</span>
      ...
      <section className='relative py-16'>
        <div className='container mx-auto px-4 relative z-10'>
          ...
          >
            <Card className='bg-white/10 border-white/20 hover:bg-white/20 transition-all duration-300 hover:scale-105'>
              <CardHeader className='text-center'>
                <div className='text-4xl mb-4'>🚰</div>
                <CardTitle className='text-xl text-white'>Sistema de Agua Potable</CardTitle>
              ...
              <CardContent>
                ...
                <div className='text-center'>
                  ...
                  <div className='text-white/60 text-xs'>Hogares beneficiados</div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className='bg-white/10 border-white/20 hover:bg-white/20 transition-all duration-300 hover:scale-105'>
              <CardHeader className='text-center'>
                <div className='text-4xl mb-4'>🌳</div>
                <CardTitle className='text-xl text-white'>Parque Comunitario</CardTitle>
            ...
            <Card className='bg-white/10 border-white/20 hover:bg-white/20 transition-all duration-300 hover:scale-105'>
              <CardHeader className='text-center'>
                <div className='text-4xl mb-4'>📹</div>
                <CardTitle className='text-xl text-white'>Sistema de Seguridad</CardTitle>
              ...
              <CardContent>
                ...
                <div className='text-center'>
                  ...
                  <div className='text-white/60 text-xs'>Cámaras instaladas</div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className='bg-white/10 border-white/20 hover:bg-white/20 transition-all duration-300 hover:scale-105'>
              <CardHeader className='text-center'>
                <div className='text-4xl mb-4'>🎓</div>
                <CardTitle className='text-xl text-white'>Programa Educativo</CardTitle>
              ...
              <CardContent>
                ...
                <div className='text-center'>
                  ...
                  <div className='text-white/60 text-xs'>Participantes activos</div>
                </div>
              </CardContent>
            </Card>
          </AnimatedGroup>
      ...
      <section className='relative py-20'>
        <div className='container mx-auto px-4 relative z-10'>
          <TextEffect
            ...
            per='word'
            as='h2'
            className='text-4xl md:text-5xl font-bold text-center mb-4 text-white drop-shadow-2xl'
          >
            Apoyo y Colaboración Comunitaria
          </TextEffect>
          <TextEffect
            ...
            delay={0.5}
            as='p'
            className='text-xl mb-12 text-white/90 max-w-3xl mx-auto leading-relaxed drop-shadow-lg text-center'
          >
          ...
          >
            <Card className='bg-white/10 border-white/20 hover:bg-white/20 transition-all duration-300 hover:scale-105'>
              <CardHeader className='text-center'>
                <CardTitle className='text-2xl text-white mb-2'>Donación Básica</CardTitle>
              ...
              <Card className='bg-gradient-to-br from-emerald-600/20 to-green-600/20 border-emerald-400/30 hover:scale-105 transition-all duration-300 relative'>
              ...
              <CardHeader className='text-center'>
                <CardTitle className='text-2xl text-white mb-2'>Colaborador Activo</CardTitle>
            ...
            <Card className='bg-white/10 border-white/20 hover:bg-white/20 transition-all duration-300 hover:scale-105'>
              <CardHeader className='text-center'>
                <CardTitle className='text-2xl text-white mb-2'>Patrocinador Mayor</CardTitle>
