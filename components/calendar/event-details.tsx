...
export function EventDetails({
  ...
  const event = useQuery(api.calendar.getEvents, { userId: undefined })?.find(
    e => e._id === eventId
  );
    ...
    <Card className="w-full max-w-2xl mx-auto">
      ...
      <CardContent className="space-y-6">
            ...
            {!showRSVP ? (
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <Select
                    value={rsvpStatus}
                    onValueChange={(value: any) => setRsvpStatus(value)}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                ...
                <div className="flex gap-3">
                  <Button onClick={handleRSVP}>Enviar respuesta</Button>
        ...
        <div className="text-sm text-gray-500 space-y-1 border-t pt-4">
          <div>
            Creado:{' '}
            {format(event.createdAt, "d/MM/yyyy 'a las' HH:mm", { locale: es })}
          </div>
          <div>
            Última actualización:{' '}
            {format(event.updatedAt, "d/MM/yyyy 'a las' HH:mm", { locale: es })}
          </div>
          {event.isRecurring && (
