...
export function CameraForm({ camera, onSuccess, onCancel }: CameraFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.error('Hubo un error al guardar la cámara. Por favor, inténtalo de nuevo.')
    } finally {
        ...
        <div className='grid grid-cols-2 gap-4'>
          ...
          <div>
            ...
            <Select
              ...
              onValueChange={(value) => setFormData(prev => ({ ...prev, frameRate: parseInt(value) }))}
            >
              <SelectTrigger className='mt-1'>
                <SelectValue />
              </SelectTrigger>
      ...
      <div className='space-y-4'>
        <div className='flex items-center justify-between'>
          ...
          <Switch
            ...
            onCheckedChange={(checked) => setFormData(prev => ({ ...prev, hasAudio: checked }))}
          />
        </div>
