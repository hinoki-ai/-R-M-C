...
export function WeatherAlertForm({
  ...
  const [formData, setFormData] = useState({
    ...
    startTime: alert?.startTime
      ? new Date(alert.startTime).toISOString().slice(0, 16)
      : '',
    endTime: alert?.endTime
      ? new Date(alert.endTime).toISOString().slice(0, 16)
      : '',
    areas: alert?.areas || [''],
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.error(
        'Hubo un error al guardar la alerta meteorológica. Por favor, inténtalo de nuevo.'
      );
    } finally {
    ...
    >
      ...
      <div className="space-y-4">
        ...
        <p className="text-sm text-gray-500">
          Especifica las áreas geográficas afectadas por esta alerta
          meteorológica.
        </p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div>
          <Label htmlFor="instructions">
            Instrucciones para la Comunidad *
          </Label>
          <Textarea
            id="instructions"
          ...
          <p className="text-sm text-gray-500 mt-1">
            Incluye medidas preventivas, rutas de evacuación, números de
            emergencia, etc.
          </p>
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <p className="text-sm text-gray-500">
          Las alertas activas serán visibles para todos los usuarios de la
          plataforma.
        </p>
      </div>
