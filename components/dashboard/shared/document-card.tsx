...
export function DocumentCard({ document, onDownload, onView, compact = false }: DocumentCardProps) {
            ...
            <div className='flex items-center justify-between mt-2 text-xs text-gray-500'>
              <div className='flex items-center space-x-4'>
                ...
                <span className='flex items-center space-x-1'>
                  ...
                  <span>{new Date(document.uploadDate).toLocaleDateString('es-CL')}</span>
                </span>
                <span className='flex items-center space-x-1'>
...
export function DocumentFilter({ selectedType, onTypeChange, documentCounts }: DocumentFilterProps) {
  const types: Document['type'][] = ['statutes', 'minutes', 'regulation', 'financial', 'plan']
