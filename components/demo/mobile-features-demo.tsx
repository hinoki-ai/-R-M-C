...
export function MobileFeaturesDemo() {
  ...
  const { fadeIn, scale, isReducedMotion, metrics, useIntersectionAnimation } =
    usePerformanceAnimations();
  const { isOnline, isSlowConnection, wasOffline, queueForSync, offlineFetch } =
    useOfflineFirst();
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap gap-3">
              <TouchButton
                ...
                haptic="medium"
                onLongPress={() =>
                  setDemoState(prev => ({ ...prev, lastAction: 'Long Press!' }))
                }
          ...
          <div className="text-center space-y-2">
            ...
            {isReducedMotion && (
              <Badge variant="secondary">♿ Reduced Motion Enabled</Badge>
            )}
          </div>
        </CardContent>
      </Card>
