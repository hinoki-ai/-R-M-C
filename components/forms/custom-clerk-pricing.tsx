  ...
  const supportOptions = [
    {
      ...
      description:
        'Únete a nuestras reuniones mensuales y actividades comunitarias.',
      icon: Users,
      action: 'Participar',
      href: '#contacto',
    },
    {
      title: 'Donaciones',
      description:
        'Apoya económicamente los proyectos de desarrollo comunitario.',
      icon: DollarSign,
      action: 'Donar',
      href: '/donate',
    },
    {
      title: 'Voluntariado',
      description:
        'Ofrece tu tiempo y conocimientos para ayudar a la comunidad.',
      icon: Heart,
