        ...
        <div className='max-w-md w-full space-y-4'>
          <div className='text-center'>
            ...
            <p className='text-muted-foreground mb-4'>
              El {providerName} ha fallado. Esto puede afectar el funcionamiento de la aplicación.
            </p>
          </div>
...
export function useProviderErrorHandler(providerName?: string) {
  const { captureError, resetError, hasError, errorId } = useComponentErrorBoundary(`Provider-${providerName || 'unknown'}`)

  const handleProviderError = React.useCallback((error: Error | string) => {
