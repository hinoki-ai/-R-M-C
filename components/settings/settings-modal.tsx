...
import {
  ...
  hasUnsavedChanges,
  settingsReducer,
} from '@/lib/stores/settings-reducer';
import {
  DEFAULT_SETTINGS,
  SettingsState,
  SystemHealth,
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <Select
                          ...
                          onValueChange={value =>
                            handleSettingChange('systemTheme', value)
                          }
                        >
                          <SelectTrigger className="w-48">
                            <SelectValue />
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <Switch
                          ...
                          onCheckedChange={checked =>
                            handleSettingChange('securityLogs', checked)
                          }
                        />
                      </div>
                    </CardContent>
                    ...
                    <CardContent className="space-y-4">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                          <Slider
                            ...
                            onValueChange={([value]) =>
                              handleSettingChange('cacheTTL', value)
                            }
                            max={3600}
                            min={60}
                            step={60}
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <Switch
                          ...
                          onCheckedChange={checked =>
                            handleSettingChange('imageCompression', checked)
                          }
                        />
                      </div>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <Switch
                          ...
                          onCheckedChange={checked =>
                            handleSettingChange('lazyLoading', checked)
                          }
                        />
                      </div>
                    </CardContent>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                          <Slider
                            ...
                            onValueChange={([value]) =>
                              handleSettingChange('apiRateLimit', value)
                            }
                            max={1000}
                            min={10}
                            step={10}
                      ...
                      <div className="flex items-center justify-between p-4 bg-yellow-50 rounded-lg border border-yellow-200">
                        ...
                        <Button
                          ...
                          onClick={() => {
                            if (
                              confirm(
                                '¿Estás seguro de resetear toda la configuración?'
                              )
                            ) {
