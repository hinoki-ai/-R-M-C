...
const SettingsPanels: React.FC<SettingsPanelsProps> = ({
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="space-y-2">
          ...
          <Input
            ...
            className={
              modifiedSettings.includes('systemName') ? 'border-orange-500' : ''
            }
          />
        ...
        <div className="space-y-2">
          ...
          >
            <SelectTrigger
              className={
                modifiedSettings.includes('systemTimezone')
                  ? 'border-orange-500'
                  : ''
              }
            >
      ...
      <div className="grid grid-cols-1 gap-6">
        <div className="space-y-2">
          ...
          >
            <SelectTrigger
              className={
                modifiedSettings.includes('systemTheme')
                  ? 'border-orange-500'
                  : ''
              }
            >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="space-y-2">
          ...
          <Input
            ...
            className={
              modifiedSettings.includes('sessionTimeout')
                ? 'border-orange-500'
                : ''
            }
          />
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            className={
              modifiedSettings.includes('passwordMinLength')
                ? 'border-orange-500'
                : ''
            }
          />
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-between p-4 bg-slate-50 dark:bg-slate-800/50 rounded-lg">
          <div>
            ...
            <p className="text-xs text-muted-foreground">
              Habilitar limitación de peticiones
            </p>
          </div>
          <Switch
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="space-y-2">
          ...
          <Input
            ...
            onChange={e =>
              handleSettingChange('maxWorkers', parseInt(e.target.value))
            }
            className={
              modifiedSettings.includes('maxWorkers') ? 'border-orange-500' : ''
            }
          />
        </div>
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            className={
              modifiedSettings.includes('memoryLimit')
                ? 'border-orange-500'
                : ''
            }
          />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="flex items-center justify-between p-4 bg-slate-50 dark:bg-slate-800/50 rounded-lg">
          ...
          <Switch
            ...
            onCheckedChange={checked =>
              handleSettingChange('clientPortalEnabled', checked)
            }
          />
        </div>
        ...
        <div className="flex items-center justify-between p-4 bg-slate-50 dark:bg-slate-800/50 rounded-lg">
          ...
          <Switch
            ...
            onCheckedChange={checked =>
              handleSettingChange('advancedAnalytics', checked)
            }
          />
        </div>
        ...
        <div className="flex items-center justify-between p-4 bg-slate-50 dark:bg-slate-800/50 rounded-lg">
          ...
          <Switch
            ...
            onCheckedChange={checked =>
              handleSettingChange('mobileAppEnabled', checked)
            }
          />
        </div>
        ...
        <div className="flex items-center justify-between p-4 bg-slate-50 dark:bg-slate-800/50 rounded-lg">
          ...
          <Switch
            ...
            onCheckedChange={checked =>
              handleSettingChange('apiAccessEnabled', checked)
            }
          />
        </div>
      </div>
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardContent className="p-6">{renderActivePanel()}</CardContent>
      </Card>
