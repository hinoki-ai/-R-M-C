      ...
      {showSplash && (
        ...
        >
          ...
          <div className='relative z-10 text-center'>
            ...
            >
              {[
                { icon: '🏠', title: 'Property Management', desc: 'Manage community properties efficiently' },
                { icon: '👥', title: 'Resident Portal', desc: 'Connect with your neighbors' },
                { icon: '📊', title: 'Analytics Dashboard', desc: 'Track community insights' }
              ].map((feature, index) => (
                <motion.div
                  key={feature.title}
