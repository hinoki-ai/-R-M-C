...
export function MobileWeatherScreen({
  onBack,
  weatherData,
  forecast = [],
  alerts = [],
}: MobileWeatherScreenProps) {
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                {currentWeather?.location || 'Cargando...'}
              </p>
            </div>
          </div>
              ...
              <CardContent className="p-6">
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-600">
                    Los datos meteorológicos se cargarán próximamente desde
                    fuentes oficiales.
                  </p>
                </div>
              </CardContent>
                ...
                <CardContent>
                  <div className="space-y-3">
                    <div className="flex items-start space-x-3">
                      ...
                      <p className="text-sm">
                        Rondas vecinales nocturnas (condiciones favorables)
                      </p>
                    </div>
                    <div className="flex items-start space-x-3">
                      <div className="w-2 h-2 bg-blue-500 rounded-full mt-2"></div>
                      <p className="text-sm">
                        Riego de huertos comunitarios (recomendado)
                      </p>
                    </div>
                    <div className="flex items-start space-x-3">
                      <div className="w-2 h-2 bg-yellow-500 rounded-full mt-2"></div>
                      <p className="text-sm">
                        Monitorear niveles de ríos cercanos
                      </p>
                    </div>
                  </div>
                </CardContent>
                ...
                <CardContent>
                  {forecast.length > 0 ? (
                    ...
                    <div className="text-center py-8">
                      ...
                      <p className="text-gray-600">
                        El pronóstico meteorológico estará disponible
                        próximamente.
                      </p>
                    </div>
                  )}
