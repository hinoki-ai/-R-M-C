  ...
  async testNetworkErrors(): Promise<void> {
    ...
    for (const { name, test } of tests) {
      try {
        ...
        this.results.push({ testName: name, passed: false, error: error as Error })
      }
    }
  }
    ...
    const tests = [
      {
        ...
        test: async () => {
          ...
          errorLogger.logConvexError(error, { operation: 'testMutation', test: true })
          return true
        }
      },
      {
        ...
        test: async () => {
          ...
          errorLogger.logConvexError(error, { operation: 'testQuery', test: true })
          return true
        }
      }
    ]
    ...
    const tests = [
      {
        ...
        test: async () => {
          ...
          const requestId = offlineManager.queueRequest('testOperation', { test: true })
